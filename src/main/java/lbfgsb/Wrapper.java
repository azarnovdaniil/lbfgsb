...
public class Wrapper {
    ...
    public IterationsInfo iterate(DifferentiableFunction fun, int maxIterations, IterationFinishedListener listener)
    ...
    private static void copyArrayJava2C(double[] arrJ, SWIGTYPE_p_double arrC) {
        for (int i = 0; i < arrJ.length; i++)
            lbfgsb_wrapper.doubleArray_setitem(arrC, i, arrJ[i]);
    }

    private static double[] convertArrayC2Java(SWIGTYPE_p_double arrC, int length) {
