...
subroutine mainlb(n, m, x, l, u, nbd, f, g, factr, pgtol, ws, wy, &
    ...
    if (.not. cnstnd .and. col .gt. 0) then
        ...
        if (iprint .ge. 1) print *, "skip the search for GCP."
    ...
    if (stp .eq. one) then
        ...
        dr = (gd - gdold) * stp
!        print *, "899 d before scal:", d
        call dscal(n, stp, d, 1)
!        print *, "901 d after scal:", d
        ddum = -gdold * stp
    endif
...
subroutine cauchy(n, x, l, u, nbd, g, iorder, iwhere, t, d, xcp, &
    ...
    if (theta .ne. one) then
        ...
        if (iprint .ge. 1) print *, "1546 p before scal:", p, "; col+1: ", col+1, "; theta: ", theta
        call dscal(col, theta, p(col + 1), 1)
        if (iprint .ge. 1) print *, "1546 p after scal:", p, "; col+1: ", col+1, "; theta:", theta
    endif
...
subroutine subsm (n, m, nsub, ind, l, u, nbd, x, d, xp, ws, wy, &
    ...
    if (iprint .ge. 1) print *, "3264 d before scal:", d, " nsub=", nsub, "1/theta=", 1./theta
    call dscal(nsub, one / theta, d, 1)
    if (iprint .ge. 1) print *, "3266 d after scal:", d
    !
    !-----------------------------------------------------------------
